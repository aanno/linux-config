...
wget https://github.com/gitbucket/gitbucket-gist-plugin/releases/download/4.14.0/gitbucket-gist-plugin-assembly-4.14.0.jar
...
wget https://github.com/nus/gitbucket-plantuml-plugin/releases/download/v1.3.0/gitbucket-plantuml-plugin-assembly-1.3.0.jar
