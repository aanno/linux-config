...
wget https://github.com/gitbucket/gitbucket-gist-plugin/releases/download/4.15.0/gitbucket-gist-plugin-assembly-4.15.0.jar
...
wget https://github.com/gitbucket/gitbucket-emoji-plugin/releases/download/4.5.1/gitbucket-emoji-plugin_2.12-4.5.1.jar
